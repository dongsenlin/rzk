...
const VOM = window.VO || { lines: [], song: 78.37, songLen: 27.7, total: 130.8 };   // build/vo/manifest.json (timeline.py)
const SONG_AT = VOM.song, SONG = VOM.songLen;
const FPS = 30, DUR = VOM.total, NFRAMES = Math.round(FPS * DUR);
...
// ───────────── palette: mineral pigments on an aged lime ground ─────────────
const C = {
  ink: '#241A16', line: '#4E2519', lineRed: '#8A3A26',                 // 墨 · 土红线
  ground: '#D8C39C', groundDk: '#B89A70', plaster: '#E4D3B2',           // 白粉地 · 泥层
  red: '#A83C2A', redHi: '#C9533A', redDeep: '#6A2218',                 // 朱砂 / 土红
  ochre: '#B27A3E', yellow: '#D4A348',                                   // 赭石 · 石黄
  azure: '#2E5B8A', azureLt: '#6F97BC', azureDk: '#1D3656',             // 石青
  mala: '#3E8A6C', malaLt: '#86BCA0', malaDk: '#24594A',                // 石绿
  white: '#EFE7D4', skin: '#EDCDAA', skinShade: '#C97B5C', blush: '#D8745A',
  gold: '#CFA24A', goldHi: '#F4DB8E', goldDeep: '#86621F',
  black: '#1B1412', night: '#120E0C', torch: '#FFB25A',
  verm: '#B3302A', vermHi: '#D8463A', vermDeep: '#6E1B17', moon: '#EEE8D8',
};
const FONT = { kai: '"Ma Shan Zheng", "Noto Serif SC"', xing: '"Zhi Mang Xing", "Ma Shan Zheng"', cao: '"Liu Jian Mao Cao", "Zhi Mang Xing"',
...
window.META = { W, H, FPS, DUR, NFRAMES, BPM, SONG_AT, SONG };
