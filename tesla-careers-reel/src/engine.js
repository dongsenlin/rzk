...
// ───────────── palette (tesla.cn design tokens) ─────────────
const C = {
  blue: '#3E6AE1', blueHi: '#6E91F2', blueGlow: '#2F5BE0',
  ink: '#171A20', graphite: '#393C41', pewter: '#5C5E62', fog: '#8E8E8E',
  pale: '#D0D1D2', cloud: '#EEEEEE', ash: '#F4F4F4', white: '#FFFFFF',
  night: '#0B0D11', night2: '#11141A',
};
const FONT = { zh: '"NotoSC"', en: '"Manrope", "NotoSC"', mono: '"GeistMono", "NotoSC"' };
...
const SCR_ZH = '能源交通智能机器人工程制造设计数据未来世界线创造突破电池超级工厂软件视觉神经网络';
