...
// ───────────── palette (Xiaomi SkyNomad) ─────────────
const C = {
  ink: '#0A0B0D', night: '#07080A', white: '#FFFFFF', paper: '#F4F3EF',
  teal: '#5FB6AA', tealHi: '#9BDCD2', tealDeep: '#2E6B66',      // 远山青
  sun: '#FF7A2F', sunHi: '#FFB066',                              // 晨光橙 (Xiaomi orange family)
  gray: '#8B9096', gray2: '#5B6066', dim: 'rgba(255,255,255,0.55)',
  fog: '#8E8E8E', pewter: '#5C5E62', graphite: '#393C41', blue: '#3E6AE1', blueHi: '#6E91F2', blueGlow: '#2F5BE0',
};
const FONT = { zh: '"MiSans VF", "MiSans", "NotoSC"', en: '"MiSansLatin VF", "MiSans VF", "NotoSC"', heavy: '"MiSansLatin", "MiSans", "NotoSC"', mono: '"MiSansLatin VF", "MiSans VF"' };
